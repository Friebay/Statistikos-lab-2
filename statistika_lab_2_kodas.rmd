...
## Komercinių patalpų ploto ir kainos koreliacija

Nulinė hipotezė ($H_0$): nėra tiesinio ryšio tarp komercinių patalpų ploto ir kainos
$$H_0: \rho = 0$$

Alternatyvioji hipotezė ($H_1$): egzistuoja statistiškai reikšmingas teigiamas tiesinis ryšys tarp komercinių patalpų ploto ir kainos
$$H_1: \rho > 0$$

kur:

- $\rho$ - Pirsono koreliacijos koeficientas tarp komercinių patalpų ploto ir kainos
...
## Komercinių patalpų ploto ir peržiūrų skaičiaus koreliacija
...
- $\rho$ - Pirsono koreliacijos koeficientas tarp komercinių patalpų ploto ir peržiūrų skaičiaus
...
Komercinių patalpų ploto ir peržiūrų skaičiaus koreliacijos hipotezei naudosime parametrinį Pirsono koreliacijos koeficiento testą.
...
## Komercinių patalpų ploto ir peržiūrų skaičiaus koreliacijos tyrimas
```{r}
...
## Peržiūrų ir ploto korealiacija
```{r}
