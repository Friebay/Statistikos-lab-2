...
Komercinių patalpų ploto ir peržiūrų skaičiaus koreliacijai naudosime Pirsono koreliacijos koeficiento testą.
...
critical_chi_sq
```
Kadangi $\chi^2 = 1.6181 < 3.841 = \chi^2_{0.05(1)}$, tai padarome išvadą, kad privačių pardavėjų proporcijų skirtumas tarp butų ir namų rinkų nėra statistiškai reikšmingas ($H_0$ negalime atmesti). Tai reiškia, kad privačių pardavėjų proporcijos abiejose rinkose yra panašios.
